...
public class Tree<T> implements DefaultBinaryTree<T> {
    ...
    public static int elementTemp;
    public static int numberOfTimes = 0;
    public static int numberOfTimesTemp = 0;
    ...
    public static int findMaxElement(DefaultBinaryTree<Integer> tree) throws Exception {

        tree.postOrderVisit((value, level) -> {
            tree.postOrderVisit((valueTemp, levelTemp) -> {
            ...
            if (numberOfTimesTemp > numberOfTimes) {
                numberOfTimes = numberOfTimesTemp;
                element = elementTemp;
            }
            numberOfTimesTemp = 0;
        });
