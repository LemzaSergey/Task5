...
public class MainFrame extends JFrame {
    ...
    public MainFrame() {
        this.setTitle("Frequent Meaning");
        ...
        findMaxElement.addActionListener(actionEvent -> {
            try {
                max = Tree.findMaxElement(tree);

                textField1.setText("Самый часто встречаемый элемент : " + max);
        ...
        buttonSaveImage.addActionListener(actionEvent -> {
            ...
            try {
                if (fileChooserSave.showSaveDialog(MainFrame.this) == JFileChooser.APPROVE_OPTION) {
